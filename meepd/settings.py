...
DATABASES = {
    'default': {
        ...
        'NAME': 'meep.db',                      # Or path to database file if using sqlite3.
...
# system time zone.
TIME_ZONE = 'America/Detroit US/Michigan'
...
SECRET_KEY = '1ot%u@^(a6f8i!p!bfr+ce(vd))ft^(t(63spxe^xa_k5m$c^b'
